...
const RELEASE_SEEDS: ReleaseSeed[] = [
  ...
  { slug: "the-orange-album", title: "The Orange Album", catalog_number: "HMB002b", artist: "evan-marcus", year: 2013, format: ["cd", "digital"], discogs_id: "12157212", note: "HMB002b per label decision 2026-04-23; renumbered from the Discogs-listed HMB002 to distinguish from Catnip & Claws Halcyon Days EP (HMB002, 2011). Suffix letters on catalog numbers are lowercase, matching HMB005b on Explorers Vol 2." },
