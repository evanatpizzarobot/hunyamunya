...
export function generateMetadata(): Metadata {
  return buildMetadata({
    ...
    description:
      "Vinyl catalog from Hunya Munya Records: 12\" HMR001 to HMR010 and full-length CD releases since 2003 on an independent Los Angeles ambient electronic label.",
    path: "/catalog/vinyl",
  });
}
