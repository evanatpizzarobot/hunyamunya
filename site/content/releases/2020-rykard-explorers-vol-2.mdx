...
proof_points:
  ...
  - label: Digital release (cat. HMB005b)
...
Released digital-only (cat. HMB005b). Mike Stanton reviewed it in I Heart Noise, calling the record "a heady trip into the deepest and warmest electronic bliss-core" and "a record of sublime electronic exploration."
